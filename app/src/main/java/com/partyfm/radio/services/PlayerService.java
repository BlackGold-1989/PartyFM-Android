...
public class PlayerService extends MediaBrowserServiceCompat implements RadioListener, AudioFocusAwarePlayer {
    ...
    private void buildNotification(String subTitle, boolean isMute, boolean isPlaying) {
        ...
        remoteViews.setImageViewResource(R.id.notification_mute, isMute ? R.drawable.ic_lib_mute : R.drawable.ic_lib_unmute);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // ACTION STOP
            ...
            if (mStation != null && mStation.getPlaybackState() != PLAYBACK_STATE_STOPPED) {
                ...
                isPlaying = false;
                buildNotification("", soundMute, isPlaying);
            } else if (mStation != null){
                FragmentRadio.onStartRadioStream();
                mController.getTransportControls().play();
                isPlaying = true;
                buildNotification(getString(R.string.connecting), soundMute, isPlaying);
            }
        }
    ...
    private void startPlayback() {
        ...
        if (mStation == null || radioManager == null ||  mSession == null) {
            Log.e(LOG_TAG, "Unable to start playback. An error occurred. Station is probably NULL.");
            saveAppState();
...
//            skipActions = 0;
    ...
    public void updateMediaInfoFromBackground(String title) {
        ...
        // update notification
        buildNotification(mTitle, soundMute, true);
    }
